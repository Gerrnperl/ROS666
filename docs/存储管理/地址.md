...
- [存储管理/地址](#存储管理地址)
  - [虚拟地址（VirtualAddress）](#虚拟地址virtualaddress)
    - [核心方法](#核心方法)
      - [与 `usize` 互相转换](#与-usize-互相转换)
      - [与 虚拟页号 `VirtualPageNumber` 互相转换](#与-虚拟页号-virtualpagenumber-互相转换)
      - [计算相关地址](#计算相关地址)
  - [物理地址（PhysicalAddress）](#物理地址physicaladdress)
    - [核心方法](#核心方法-1)
      - [与 `usize` 互相转换](#与-usize-互相转换-1)
      - [与 物理页号 `PhysicalPageNumber` 互相转换](#与-物理页号-physicalpagenumber-互相转换)
      - [计算相关地址](#计算相关地址-1)
      - [内存操作](#内存操作)
  - [虚拟页号（VirtualPageNumber）](#虚拟页号virtualpagenumber)
    - [物理页号（PhysicalPageNumber）](#物理页号physicalpagenumber)
  - [小结](#小结)
