...
//! ## References:
//!
//! Copied from [rCore-Tutorial-v3/os/src/drivers/block/sdcard.rs](https://github.com/rcore-os/rCore-Tutorial-v3/blob/ch6-dbg/os/src/drivers/block/sdcard.rs)
//! - Author: [wyfcyx](https://github.com/wyfcyx)
//! - License: GPL-3.0 license
//!
//! Modified by Gerrnperl
//!
//! ## Dependencies:
//!
//! - [Gerrnperl/k210-hal](https://github.com/Gerrnperl/k210-hal)
//!     - (forked from [wyfcyx/k210-hal](https://github.com/wyfcyx/k210-hal))
//!          - (forked from [riscv-rust/k210-hal](https://github.com/riscv-rust/k210-hal))
//! - [wyfcyx/k210-pac](https://github.com/wyfcyx/k210-pac)
//!     - (forked from [riscv-rust/k210-pac](https://github.com/riscv-rust/k210-pac))
//! - [Gerrnperl/k210-soc](https://github.com/Gerrnperl/k210-soc)
//!     - (forked from [wyfcyx/k210-soc](https://github.com/wyfcyx/k210-soc))
//!
...
use crate::{printkln, utils::safety::SyncRefCell};
...
use k210_soc::{
    ...
    gpiohs,
    sleep::usleep,
    spi::{SPI, SPIExt, SPIImpl, aitm, frame_format, tmod, work_mode},
    sysctl,
};
use lazy_static::*;
...
lazy_static! {
    static ref PERIPHERALS: SyncRefCell<Peripherals> =
        unsafe { SyncRefCell::new(Peripherals::take().unwrap()) };
}
...
fn init_sdcard() -> SDCard<SPIImpl<SPI0>> {
    ...
    printkln!("init sdcard!");
    sd
}

pub struct SDCardWrapper(SyncRefCell<SDCard<SPIImpl<SPI0>>>);

impl SDCardWrapper {
    pub fn new() -> Self {
        unsafe { Self(SyncRefCell::new(init_sdcard())) }
    }
}
